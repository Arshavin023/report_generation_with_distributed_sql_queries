-- PROCEDURE: ahd.proc_previous(character varying)

-- DROP PROCEDURE IF EXISTS ahd.proc_previous(character varying);

CREATE OR REPLACE PROCEDURE ahd.proc_previous(
...
EXECUTE FORMAT('TRUNCATE ahd.%I',cteprevious_partition);
...
VALUES (%L,%L, %L, %L)',
ahdmonitoringpartition,cteprevious_partition,start_time,end_time,datim_id);

END
$BODY$;
ALTER PROCEDURE ahd.proc_previous(character varying)
    OWNER TO lamisplus_etl;

-- CALL ahd.proc_previous('A1xxdELs2fm');
