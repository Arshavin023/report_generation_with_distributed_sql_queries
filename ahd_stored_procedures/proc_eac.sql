-- PROCEDURE: ahd.proc_eac(character varying)

-- DROP PROCEDURE IF EXISTS ahd.proc_eac(character varying);

CREATE OR REPLACE PROCEDURE ahd.proc_eac(
...
EXECUTE FORMAT('TRUNCATE ahd.%I',cteeac_partition);
...
VALUES (%L,%L, %L, %L)',
ahdmonitoringpartition,cteeac_partition,start_time,end_time,datim_id);

END
$BODY$;
ALTER PROCEDURE ahd.proc_eac(character varying)
    OWNER TO lamisplus_etl;

-- CALL ahd.proc_eac('A1xxdELs2fm');
