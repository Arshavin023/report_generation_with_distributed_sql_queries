-- PROCEDURE: ahd.proc_current_vl_result(character varying)

-- DROP PROCEDURE IF EXISTS ahd.proc_current_vl_result(character varying);

CREATE OR REPLACE PROCEDURE ahd.proc_current_vl_result(
...
EXECUTE FORMAT('TRUNCATE ahd.%I',ctecurrentvlresult_partition);
...
VALUES (%L,%L, %L, %L)',
ahdmonitoringpartition,ctecurrentvlresult_partition,start_time,end_time,datim_id);

END
$BODY$;
ALTER PROCEDURE ahd.proc_current_vl_result(character varying)
