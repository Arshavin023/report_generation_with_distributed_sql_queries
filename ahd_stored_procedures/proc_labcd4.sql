-- PROCEDURE: ahd.proc_labcd4(character varying)

-- DROP PROCEDURE IF EXISTS ahd.proc_labcd4(character varying);

CREATE OR REPLACE PROCEDURE ahd.proc_labcd4(
...
EXECUTE FORMAT('TRUNCATE ahd.%I',ctelabcd4_partition);
...
VALUES (%L,%L, %L, %L)',
ahdmonitoringpartition,ctelabcd4_partition,start_time,end_time,datim_id);

END
$BODY$;
ALTER PROCEDURE ahd.proc_labcd4(character varying)
    OWNER TO lamisplus_etl;

-- CALL ahd.proc_labcd4('A1xxdELs2fm');
